...
const navigationMenuTriggerStyle = cva(
  'cursor-pointer group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium hover:bg-transparent focus:bg-transparent disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-transparent data-[state=open]:bg-transparent ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 transition-[box-shadow] focus-visible:ring-4 focus-visible:outline-1',
);
